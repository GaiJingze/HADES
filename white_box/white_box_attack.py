...
from llava.mm_utils import read_json_file, item_process_func, create_adv_noise, DataCollatorForSupervisedDataset, QuestionDataset, Generator, apply_adv_noise_to_batch, denormalize, get_model_name_from_path
import time
...
if __name__ == "__main__":
    ...
    image_file = 'Violence/1/opt_1.jpg'
